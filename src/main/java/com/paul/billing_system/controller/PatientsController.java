...
public class PatientsController {
    ...
    public ResponseEntity<?> savePatients(@Valid @RequestBody PatientDTO patientDTO,
        ...
        PatientDTO patientDTO1 = PatientDTO.form(patientService.savePatients(id, patientDTO));
    ...
    public ResponseEntity<?> getAllPatients(@PathVariable Long id ,
        ...
        List<Patient> patients = patientService.getAllPatients(id, PageRequest.of(page,size));
    ...
    public ResponseEntity<?> getPatientById(@PathVariable Long id){
        PatientDTO patientDTO = PatientDTO.form(patientService.getPatientById(id));
    ...
    public ResponseEntity<?> updatePatient(@Valid @PathVariable Long id, @RequestBody PatientDTO patientDTO, BindingResult bindingResult){
        ...
        PatientDTO patientDTO1 = PatientDTO.form(patientService.updatePatient(patientDTO,id));
        return new ResponseEntity<>(patientDTO1,HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> searchPatient(@PathVariable String name,
        ...
        return new ResponseEntity<>(patientService.searchPatient(name, PageRequest.of(page, size))
                .stream()
                .map(PatientDTO::form)
